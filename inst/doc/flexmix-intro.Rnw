...
%  $Id: flexmix-intro.Rnw 3193 2007-01-04 10:35:17Z gruen $
%
\documentclass[JSS]{jss-old}

\title{FlexMix: A General Framework for Finite Mixture Models and
  Latent Class Regression in \proglang{R}\thanks{This article was
    originally published in \emph{Journal of Statistical Software},
    October 2004, Volume 11, Issue 8. It has been modified to reflect
    the changes made to the package. Please use the version published
    in JSS for citation.}}

\subtitle{\pkg{flexmix} version
  \Sexpr{packageDescription("flexmix",fields="Version")}\\\today}
...
\author{Friedrich Leisch\\Ludwig-Maximilians-Universit{\"a}t M{\"u}nchen} 
...
\begin{description}
 \item[fit:] A \texttt{function(x,y,w)} returning an object of class
  \texttt{"FLXcomponent"}.
\item[defineComponent:] Expression constructing the object of class
  \texttt{"FLXcomponent"}.
